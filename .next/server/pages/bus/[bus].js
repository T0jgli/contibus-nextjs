...
const OneBusBody = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 525).then(__webpack_require__.bind(__webpack_require__, 5525)), {
  ...
  loadableGenerated: {
    webpack: () => [/*require.resolve*/(5525)],
    modules: ["bus\\[bus].js -> " + "../../components/BusesComponents/OneBusBody"]
  }
});
...
const OneBus = ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(framer_motion__WEBPACK_IMPORTED_MODULE_2__.motion.section, {
    ...
    }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(OneBusBody, {
      thisbus: busData
    })]
  });
};
...
async function getServerSideProps(context) {
  const busData = await (0,_lib_SetContentFulData__WEBPACK_IMPORTED_MODULE_9__/* .setOneContentfulData */ .R)("busesData", context.query.bus);
  return {
    props: {
...
"use strict";
module.exports = require("@material-ui/icons/AirlineSeatReclineNormal");;
...
"use strict";
module.exports = require("@material-ui/icons/EmojiPeople");;
...
"use strict";
module.exports = require("@material-ui/icons/Speed");;
...
var __webpack_exports__ = __webpack_require__.X(0, [477,555,616,899], function() { return __webpack_exec__(5495); });
