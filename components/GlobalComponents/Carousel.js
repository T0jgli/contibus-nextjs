                                    ...
                                    <Fade triggerOnce direction="down">
                                        <h1 className="mb-4">
                                            <strong className="font-weight-bold">
                                                {router.locale === "en" ? (
                                                    <span>
                                                        <span className="d-none d-md-inline">Contibus – </span>Specialist Coach Travel
                                                    </span>
                                                ) : (
                                                    <span>
                                                        <span className="d-none d-md-inline">Contibus – </span>Az utazás szakértői
                                                    </span>
                                                )}
                                            </strong>
                                        </h1>
                                    ...
                                    <Fade triggerOnce>
                                        <p className="mb-4 d-block">
                                            <span style={{ letterSpacing: "1px" }}>
                                                ...
                                                {router.locale === "en" ? "We offer culture and experience" : "Kultúrát és élményt adunk"}
                                                <MDBIcon icon="check" className="px-2" />
                                            </span>
                                        </p>
                                    </Fade>
                                    ...
                                    <Fade triggerOnce>
                                        <p className="mb-4 d-block text-center">
                                            <span style={{ letterSpacing: "1px" }}>
                                                ...
                                                <MDBIcon icon="check" className="px-2" />
                                                {router.locale === "en" ? "Comfort" : "Kényelem"}
                                                <MDBIcon icon="check" className="px-2" />
                                                {router.locale === "en" ? "Standards" : "Színvonal"}
                                                <MDBIcon icon="check" className="px-2 d-md-inline d-none" />
                                            </span>
                                        </p>
                                    </Fade>
