    ...
    return (
        <>
            {ready && (
                    ...
                    <MDBContainer className="cookiealert-container">
                        <MDBRow className="justify-content-center align-items-center text-center">
                ...
                </span>{locale === "en" ? (<span> We use cookies to ensure you get the best experience on our website. By browsing this site, you accept the
                            ...
                            <MDBBtn style={{ color: "black" }} color="warning" size="md" outline className="font-weight-bolder roundedbtn acceptcookies d-block" onClick={() => {
                                ...
                                {locale === "en" ? ("I understand") : ("Rendben")}</MDBBtn>
                        </MDBRow>
                    </MDBContainer>
                </MDBAlert>
            )}
