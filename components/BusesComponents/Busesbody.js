                ...
                <MDBContainer>
                    <Fade triggerOnce>
                        <section>
                            ...
                            <p className="font-weight-bolder">{locale === "en" ?
                            ...
                            <p>{locale === "en" ? ("In addition to the indicated kilometer or hourly rate, VAT, tolls, crossing fees, city tickets, parking and a daily fee for drivers must be paid.") :
                                ...
                                {locale === "en" ? (" The accommodation of the driver(s) is provided by the customer, the amount of the daily fee varies by road types.") :
                                    (" Gépkocsivezető(-k) szállásáról a megrendelő gondoskodik, a napidíj összege úttípusonként változik.")}
                                {locale === "en" ? (" The drivers should rest 9 hours or more.") :
                                    (" A gépkocsivezetők napi pihenőideje semmilyen körülmények között sem lehet kevesebb kilenc egymást követő óránál.")}
                                {locale === "en" ? (" We provide preliminary information on tolls, ferry costs and parking.") :
                                    (" Autópályadíjakról, kompköltségekről, parkolásról előzetes tájékoztatást adunk.")}
                            </p>
                            <p className="font-weight-bolder m-0 p-0">{locale === "en" ? ("In case of regular order we provide a discount!") :
                                ("Rendszeres megrendelés esetén kedvezményt biztosítunk!")}</p>
                            <p>{locale === "en" ? ("Orders can be placed in person at our office, by letter, fax, e-mail or phone.") :
